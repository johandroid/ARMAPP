...
//	echo $query_final."<br>";
	...
	while($cadena_actual!='FIN')
	{
		...
		if (table_exists($NombreTabla, $link))
		{
		    ...
		    $query_basica = sprintf("(SELECT cliente_eventos.gw_id, cliente_eventos.instalacion_id, cliente_eventos.nodo_ip,cliente_eventos.nodo_mac, cliente_eventos.evento_codigo, cliente_eventos.alarma_id,cliente_eventos.alarma_fecha_recibida, cliente_eventos.evento_tiposensor,cliente_eventos.alarma_repuesta, cliente_eventos.alarma_fecha_repuesta, cliente_eventos.alarma_usuario_repuesta FROM %s as cliente_eventos right join cliente_gateways  on (cliente_gateways.gw_id = cliente_eventos.gw_id) WHERE (cliente_eventos.evento_codigo>'000') AND (cliente_eventos.instalacion_id='%s') %s ORDER BY alarma_fecha_recibida DESC", $NombreTabla, $instalacion, $queryaux);
	...
	$query_final = sprintf("select cliente_eventos1.gw_id AS gw_id,
							   ...
							   ORDER BY fecha DESC LIMIT %s", $db_name_general, $_SESSION['opcion_idioma'], $query_total, $db_name_general, $_SESSION['opcion_idioma'],$db_name_general, $_SESSION['opcion_idioma'], $db_name_general, $_SESSION['opcion_idioma'],$db_name_general, $_SESSION['opcion_idioma'], $num_filas_tabla);
...
echo "<td align=\"center\" width=\"$ancho_5\" class=\"RFNETBold\">".$idiomas[$_SESSION['opcion_idioma']]['general32']."</td>";
echo "</tr>";
...
else
{
	...
	else
	{
		...
		while ($row = mysql_fetch_array($result))
		{
			...
			if ($row['alarma_repuesta'] == "1")
			{
				echo "<td align=\"center\" width=\"$ancho_4\" class=\"RFNETtextborder\">"./*$row['alarma_fecha_repuesta']*/sObtener_Fecha_Desde_String($cliente_db, $instalacion, $row['alarma_fecha_repuesta'],$zona_horaria)."</td>";
				if ($row['alarma_usuario_repuesta'])
				{
					echo "<td align=\"center\" width=\"$ancho_5\" class=\"RFNETtextborder\">".$row['alarma_usuario_repuesta']."</td>";
				}
				else
				{
			...
			{
				echo "<td align=\"center\" width=\"$ancho_4\" class=\"RFNETtextborder\">".$idiomas[$_SESSION['opcion_idioma']]['general_no']."</td>";
	...
	while ($cuenta_filas < $num_filas_tabla)
	{
		if ((($cuenta_filas)%2) == 0)
		{
			echo "<tr class=\"tipo_fila_2\"><td align=\"center\" width=\"$ancho_1\" class=\"RFNETtextborder\"><br></td><td align=\"center\" width=\"$ancho_2\" class=\"RFNETtextborder\"><br></td><td align=\"center\" width=\"$ancho_3\" class=\"RFNETtextborder\"><br></td><td align=\"center\" width=\"$ancho_4\" class=\"RFNETtextborder\"><br></td><td align=\"center\" width=\"$ancho_5\" class=\"RFNETtextborder\"><br></td></tr>";
		}
		else
		{
			 echo "<tr class=\"tipo_fila_1\"><td align=\"center\" width=\"$ancho_1\" class=\"RFNETtextborder\"><br></td><td align=\"center\" width=\"$ancho_2\" class=\"RFNETtextborder\"><br></td><td align=\"center\" width=\"$ancho_3\" class=\"RFNETtextborder\"><br></td><td align=\"center\" width=\"$ancho_4\" class=\"RFNETtextborder\"><br></td><td align=\"center\" width=\"$ancho_5\" class=\"RFNETtextborder\"><br></td></tr>";
		}
