...
?>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; font-size:10px;">
		  		<tr>
				    ...
				    <td align="right" style="font-size:11px">
				      ...
				      <a href="index.php?opcion_idioma=<?php echo $_SESSION['opcion_idioma'];?>"><?php echo $idiomas[$_SESSION['opcion_idioma']]['title_logoff'];?></a>&nbsp;&nbsp;
				    </td>
	      		</tr>
	    	</table>
	   </td>
	...
	<tr height="505px">
		<td align="left" valign="top" id="celda_submenu"></td>
		<td align="center">
