...
<head>
	...
	<script type="text/javascript">
		function vCargar_Params_SMS()
		{
			var xmlHttpParam;
			var sNombreCombo;
			xmlHttpParam= GetXmlHttpObject();
			var url = "carga_params_sms.php?instalacion_id="+top.document.getElementById("comboInstalaciones").options[top.document.getElementById("comboInstalaciones").selectedIndex].value+"&cliente_db="+top.document.getElementById('db_cliente').value;
...
<?php
	if ($_POST['Actualizar'])
	{
		...
		$query="UPDATE cliente_instalaciones SET instalacion_sms_telf1_on='".$telf1_on."', instalacion_sms_telf1='".$telf1."', instalacion_sms_telf1_idioma='".$telf1_idioma."', instalacion_sms_telf2_on='".$telf2_on."', instalacion_sms_telf2='".$telf2."', instalacion_sms_telf2_idioma='".$telf2_idioma."' WHERE instalacion_id='".$_POST['id_instalacion']."'";
		//echo $query;
...
?>
	...
	<tr>
		<td align="center">
			<div class="rounded-big-box" style="width:70%">
				...
				<div class="box-contents">
					<table border="0" width="100%" cellpadding="0" cellspacing="0" >
						...
						<tr style="width:100%">
							...
							<td style="width:25%" align="center">
								<input type="text" name="telf1" id="telf1" style="width:100px;text-align:center" class="texto_valores" maxlength="24"/>
							</td>
							<td style="width:25%" align="center">
						...
						<tr style="width:100%">
							...
							<td style="width:25%" align="center">
								<input type="text" name="telf2" id="telf2" style="width:100px;text-align:center" class="texto_valores" maxlength="24"/>
							</td>
							<td style="width:25%" align="center">
