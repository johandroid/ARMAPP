...
Protoplasm.loadStylesheet('datepicker.css', 'js/datepicker');
/**
...
initialize: function(element, options) {
	...
	if (!options.icon)
	options.icon = Protoplasm.base('img')+'calendar.png';
	/**
...
Control.DatePicker.i18n = Class.create();
	...
	available: ['cs_CZ', 'el_GR', 'fr_iso8601', 'it_IT', 'lt_LT', 'nl_NL', 'pl_PL', 'pt_BR', 'ru_RU'],
	baseLocales: {
		'us': {
