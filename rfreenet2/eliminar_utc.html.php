...
<head>
	...
	<script type="text/javascript">
		...
		{
			var alta_offline;
			if (confirm(iObtener_Cadena_AJAX('utc_text2')+" <?php echo $_GET['objeto_texto']?>\r\n"+iObtener_Cadena_AJAX('general0')))
			{
				...
				var url = "utc_eliminar.php?cliente_db="+top.document.getElementById("db_cliente").value+"&instalacion_id="+top.document.getElementById("comboInstalaciones").options[top.document.getElementById("comboInstalaciones").selectedIndex].value+"&disp_id=<?php echo $_GET['objeto_id']?>"+"&offline="+alta_offline;
				...
				xmlHttpgrRead.onreadystatechange = function()
				{
					if (xmlHttpgrRead.readyState==4)
					{
						...
						window.parent.cargar_utcs("comboUTCs",top.document.getElementById("comboInstalaciones").options[top.document.getElementById("comboInstalaciones").selectedIndex].value);
					}
				}
				xmlHttpgrRead.send();
			}
...
<body>
	<table border="0" width="100%" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td colspan="3" align="center">
				<span class="texto_titulo_tooltip"><?php echo $idiomas[$_SESSION['opcion_idioma']]['general56'].' '.$idiomas[$_SESSION['opcion_idioma']]['general255'].' '.$_GET['objeto_texto']?></span>
			</td>
		</tr>
		<tr>
	...
	<script type="text/javascript">
		var sUTCGWId = sCargar_GW_UTC(<?php echo $_GET['objeto_id']?>);
		vCargar_Versiones_GW_DB(sUTCGWId);
	</script>
</body>
</html>