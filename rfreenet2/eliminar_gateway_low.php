	...
	<script type="text/javascript">
		function OnConfirmarEliminar()
		{
			if (confirm(iObtener_Cadena_AJAX('gw_text4')+" <?php echo $_GET['objeto_id']?>\r\n"+iObtener_Cadena_AJAX('general0')))
			{
				...
				var url = "gw_eliminar_low.php?cliente_db="+top.document.getElementById("db_cliente").value+"&gw_id=<?php echo $_GET['objeto_id']?>";
				...
				window.parent.cargar_gateways_low("comboGateways",top.document.getElementById("comboInstalaciones").options[top.document.getElementById("comboInstalaciones").selectedIndex].value);
			}
		}
	</script>
</head>
