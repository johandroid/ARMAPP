...
function dhtmlXTabBar(parentObject,mode,height){mode=mode||"top"
 ...
 this._py="left";this._px="top";this._pxc="bottom";break};this._active= null;this._tabs = {};this._content = {};this._href={};this._rows=[];this._s._tabSize=150;this._styles={"default":{left:3, right:3, select_shift:3, select_top:2, margin:1, offset:5, tab_color:"#F4F3EE", data_color:"#AFAFAF" },
 ...
 "modern":{left:5, right:5, select_shift:3, select_top:2, margin:1, offset:5, tab_color:"#F4F3EE", data_color:"#AFAFAF" },
 "silver":{left:7, right:7, select_shift:3, select_top:2, margin:1, offset:5, tab_color:"#F4F3EE", data_color:"#AFAFAF" },
 ...
 "dhx_blue":{left:2, right:2, select_shift:3, select_top:0, margin:1, offset:5, tab_color:"#F4F3EE", data_color:"#AFAFAF" },
 "dhx_skyblue":{left:3, right:3, select_shift:1, select_top:0, margin:-1, offset:5 , data_color:"#E2E2E2", hover:true }};if (typeof(parentObject)!="object")
 ...
 getActiveTab:function(){if (!this._lastActive)return null;return this._lastActive.getAttribute("id")},
