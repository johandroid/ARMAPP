...
<head>
	...
	<script type="text/javascript">
		function vAdd_user()
		{
			...
			else if (document.getElementById("comboClientes").selectedIndex==-1)
			{
			...
			{
				switch (document.getElementById('comboClientes').selectedIndex)
				{
					case 0:
				...
				url = "usuario_anyade.php?usuario_nombre=" + document.getElementById("nombre_user").value + "&usuario_perfil=" + iPerfilAnyade + "&usuario_pw=" + document.getElementById("nombre_pw1").value + "&cliente_id=" + document.getElementById("comboClientes").options[document.getElementById("comboClientes").selectedIndex].id + "&usuario_email=" + document.getElementById('usuario_email').value;
...
<body>
	...
	<tr>
		<td align="center">
			<span><?php echo $idiomas[$_SESSION['opcion_idioma']]['general52'].' '.$idiomas[$_SESSION['opcion_idioma']]['general32']?></span>
		</td>
	</tr>
	<tr>
		<td align="center">
							...
							<td colspan="3" align="center" valign="top">
								<table border="0" width="100%" cellpadding="0" cellspacing="0" >
									...
									<tr style="width:100%">
										<td style="width:5%"><br/></td>
										<td style="width:90%" align="center">
											<select name="clientes" id="comboClientes" style="width:200px;margin:0px 0 5px 0;" onchange="onChangeClientes()">
										     	<?
